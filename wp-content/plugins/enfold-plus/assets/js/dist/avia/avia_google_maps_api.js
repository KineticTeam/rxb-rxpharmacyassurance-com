/**
 Replacements: deprecates $.avia_utilities logging in favor of console.log, also deprecates aviaMobile in favor of avia_is_mobile (avia-compat.js)
 */
...
(function($)
{
	...
	$.AviaMapsAPI  =  function(options, container)
	{
		...
		{
			console.log('Map creation stopped, var av_google_map not found'); 
			return;
		}
  	...
  	$.AviaMapsAPI.prototype =
    {
		...
		_applyMap: function()
		{
			...
			{
				console.log('Latitude or Longitude missing. Make sure you did not only enter an address. You need to fetch the coordinates too.', 'map-error'); 
				return;
			}
			
			var _self = this,
				mobile_drag = avia_is_mobile ? this.$data.mobile_drag_control : true,
			...
			{	
				...
				(function(key, _self) 
				{
					setTimeout(function()
					{
							...
							{
								console.log('Latitude or Longitude for single marker missing', 'map-error'); 
								return;
							}
						    ...
						    { 
                                ...
                                if(_self.$data.marker[key].imagesize == 'custom'){
                                    size = _self.$data.marker[key].customsize;
                                }
