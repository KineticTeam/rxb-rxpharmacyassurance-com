	...
	class avia_sc_gmaps extends aviaShortcodeTemplate
	{
		...
		protected function register_modal_group_templates()
		{
			...
			$c = array(
                        ...
                        array(
                            'name' 	=> __( 'Custom Marker Size', 'avia_framework' ),
                            'desc'  =>  __( 'Set a custom marker size here, only input numbers. If you\'re using a 2x image, input half of the value', 'avia_framework' ),
							'id' 	=> 'customsize',
							'type' 	=> 'input',
                            'std' 	=> '',
                            'required' => array( 'imagesize', 'equals', 'custom' )
						),
